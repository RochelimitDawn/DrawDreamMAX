...
**主交付：安卓本地 Node APK** · 当前发布线 **`v2.0.0-alpha.1-mobile.90`** · 单端口 **7620**
...
当前仓库以 `mobile.90` 作为唯一稳定版本。产品维护围绕桌面/平板设置体验、酒馆兼容渲染、卡内 UI 全量渲染和移动端主流程进行。
...
│   └── android/
├── scripts/
└── package.json         # 2.0.0-alpha.1-mobile.90
```
