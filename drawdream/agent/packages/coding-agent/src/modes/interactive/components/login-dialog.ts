import { getOAuthProviders, type OAuthDeviceCodeInfo } from "@drawdream/ai/oauth";
import { Container, type Focusable, getKeybindings, Input, Spacer, Text, type TUI } from "@drawdream/tui";
