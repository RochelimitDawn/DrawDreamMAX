...
import type { AssistantMessage, Model } from "@drawdream/ai";
...
vi.mock("@drawdream/ai/compat", async (importOriginal) => {
	const actual = await importOriginal<typeof import("@drawdream/ai/compat")>();
	return {
		...actual,
