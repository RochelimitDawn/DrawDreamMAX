...
<p align="center">
  ...
  <a href="https://www.npmjs.com/package/@drawdream/agent-runtime"><img alt="npm" src="https://img.shields.io/npm/v/@drawdream/agent-runtime?style=flat-square" /></a>
</p>
...
```bash
npm install -g --ignore-scripts @drawdream/agent-runtime
```
...
```typescript
import { AuthStorage, createAgentSession, ModelRegistry, SessionManager } from "@drawdream/agent-runtime";
...
- [@drawdream/ai](https://www.npmjs.com/package/@drawdream/ai): Core LLM toolkit
- [@drawdream/agent-core](https://www.npmjs.com/package/@drawdream/agent-core): Agent framework
- [@drawdream/tui](https://www.npmjs.com/package/@drawdream/tui): Terminal UI components
